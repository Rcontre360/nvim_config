...
Plug 'airblade/vim-gitgutter' "git changes on lines
...
Plug 'mg979/vim-visual-multi', {'branch': 'master'} " Multiple cursors and more
...
vmap <C-c> <plug>NERDCommenterSexy
nmap <C-c> <plug>NERDCommenterSexy
"open in last line open
...
autocmd BufWritePre *.sol,*.js,*.jsx,*.mjs,*.ts,*.tsx,*.css,*.less,*.scss,*.json,*.graphql,*.md,*.vue,*.yaml,*.html Prettier
...
" not used anymore since it doesnt work. need fix @rafael TODO
...
"nmjp <leader>f  <Plug>(coc-format-selected)
